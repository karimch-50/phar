...
/* 
        if (accessChecker.hasAccess(EmployeListView.class))
            nav.addItem(new SideNavItem("Liste Employés", EmployeListView.class,
                LineAwesomeIcon.LIST_ALT.create()));
        if (accessChecker.hasAccess(CertifListView.class))
            nav.addItem(new SideNavItem("Liste Certifs", CertifListView.class,
                LineAwesomeIcon.CERTIFICATE_SOLID.create()));*/



        SideNavItem serviceDemande = new SideNavItem("Demandes de prestation");
        serviceDemande.setPrefixComponent(LineAwesomeIcon.COG_SOLID.create());

        

        

        SideNavItem stock = new SideNavItem("Inventaire");
        stock.setPrefixComponent(LineAwesomeIcon.COG_SOLID.create());


        SideNavItem evaluation = new SideNavItem("Evaluation ISO");
        evaluation.setPrefixComponent(LineAwesomeIcon.COG_SOLID.create());
        ...
        nav.addItem(serviceDemande);
        //nav.addItem(gmao);
        nav.addItem(stock);
        nav.addItem(evaluation);
        nav.addItem(tools);
