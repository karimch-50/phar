...
var MomentNamedTimeZone = class extends NamedTimeZoneImpl {
  offsetForArray(a) {
    return import_moment_timezone.default.tz(a, this.timeZoneName).utcOffset();
  }
  timestampToArray(ms) {
    return import_moment_timezone.default.tz(ms, this.timeZoneName).toArray();
  }
};
...
*/
//# sourceMappingURL=@fullcalendar_moment-timezone.js.map
