...
import com.pharma.fs.data.Role;
import com.pharma.fs.data.User;
import com.pharma.fs.data.UserRepository;
import com.pharma.fs.security.AuthenticatedUser;
import com.pharma.fs.services.UserService;
import com.pharma.fs.views.authorization.AuthorizationView;
import com.pharma.fs.views.dashboard.DashboardView;
import com.pharma.fs.views.location.LocationListView;
import com.pharma.fs.views.organisation.organisation.OrganisationListView;
import com.pharma.fs.views.organisation.organisationType.OrganisationTypeListView;
...
public class MainLayout extends AppLayout {
    ...
    private void addDrawerContent(User user) {
		...
		Image image = new Image("/pharma/images/logo.png", "SAHTY Logo");
