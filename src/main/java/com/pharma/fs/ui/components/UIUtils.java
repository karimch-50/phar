...
import com.pharma.fs.ui.components.css.*;
import com.pharma.fs.ui.components.size.Right;
...
public class UIUtils {
	...
	private static final ThreadLocal<DecimalFormat> decimalFormat = ThreadLocal
			.withInitial(() -> new DecimalFormat("###,###0.00", DecimalFormatSymbols.getInstance(Locale.FRANCE)));
	...
	public static Paragraph createParagraph(FontSize size, TextColor color,
	                                String text) {
	...
	public static Paragraph createParagraph(FontSize size, String text) {
		return createParagraph(size, TextColor.BODY, text);
	}

	public static Paragraph createParagraph(TextColor color, String text) {
		return createParagraph(FontSize.M, color, text);
	}

	public static Paragraph createH1Paragraph(String text) {
		Paragraph label = new Paragraph(text);
		label.addClassName(LumoStyles.Heading.H1);
		return label;
	}

	public static Paragraph createH2Paragraph(String text) {
		Paragraph label = new Paragraph(text);
		label.addClassName(LumoStyles.Heading.H2);
		return label;
	}

	public static Paragraph createH3Paragraph(String text) {
		Paragraph label = new Paragraph(text);
		label.addClassName(LumoStyles.Heading.H3);
		return label;
	}

	public static Paragraph createH4Paragraph(String text) {
		Paragraph label = new Paragraph(text);
		label.addClassName(LumoStyles.Heading.H4);
		return label;
	}

	public static Paragraph createH5Paragraph(String text) {
		Paragraph label = new Paragraph(text);
		label.addClassName(LumoStyles.Heading.H5);
		return label;
	}

	public static Paragraph createH6Paragraph(String text) {
		Paragraph label = new Paragraph(text);
	...
	public static Paragraph createAmountParagraph(double amount) {

		Paragraph label = createH5Paragraph(formatAmount(amount));
	...
	public static Paragraph createUnitsParagraph(int units) {
		Paragraph label = new Paragraph(formatUnits(units));
		label.addClassName(LumoStyles.FontFamily.MONOSPACE);
		return label;
	}
	...
	public static void setAriaParagraph(String value, Component... components) {
		for (Component component : components) {
